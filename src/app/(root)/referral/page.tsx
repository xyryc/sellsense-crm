      ...
      {!referralData ? (
        <div className="p-6 rounded-lg shadow-md border mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Generate a unique referral code to share with friends. You'll earn
            50 points for each successful referral!
          </p>
          <Button onClick={generateReferralCode} disabled={isLoading}>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-5 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600 text-sm">
              Click the button to create your unique referral code.
            </p>
          </div>
          <div className="p-5 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600 text-sm">
              Send your referral code or link to friends and invite them to
              join.
            </p>
          </div>
          <div className="p-5 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600 text-sm">
              Get 50 points for each friend who signs up using your code.
            </p>
          </div>
        </div>
      </div>
